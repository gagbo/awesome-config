-- * bar_themes/aligatueur.lua -- Personal Bar theme for Aligatueur
...
local secrets_available, secrets = pcall(require, "secrets")
...
-- * Bar definition
aligatueur_bar.setup_bar = function()
